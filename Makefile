...
runtest: test.cpp formula.cpp euf.cpp googletest/build/lib/libgtest.a
	make -C minisat
	g++ --debug -o runtest -pthread  -I minisat -I googletest/googletest/include test.cpp formula.cpp euf.cpp googletest/build/lib/libgtest.a  minisat/build/release/lib/libminisat.a
