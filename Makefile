...
runtest: test.cpp formula.cpp euf.cpp googletest/build/lib/libgtest.a euf.h
	make -C minisat
	g++ -std=c++20 --debug -o runtest -pthread  -I minisat -I googletest/googletest/include test.cpp formula.cpp euf.cpp googletest/build/lib/libgtest.a  minisat/build/release/lib/libminisat.a
